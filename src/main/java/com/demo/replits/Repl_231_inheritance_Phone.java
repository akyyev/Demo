...
public class Repl_231_inheritance_Phone {

    public static void main(String[] args) {
        CameraPhone iphone = new CameraPhone(8, 64);
        int suratSany = iphone.numPictures();

        System.out.printf("Sizing iphonyngyz bilen %s sany surat alyp bolyar!!!", suratSany);
...
class CameraPhone extends Phone{
    int imageSize; // mega-pixel => megabyte
    int memorySize;  //gb ==> 1000 megabyte

    //to give initial values to the instances of an abject
